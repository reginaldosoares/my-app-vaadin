...
@Route(value = "collaborative-master-detail/:sampleFoodProductID?/:action?(edit)", layout = MainLayout.class)
public class CollaborativeMasterDetailView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEFOODPRODUCT_EDIT_ROUTE_TEMPLATE = "collaborative-master-detail/%d/edit";
    ...
    public CollaborativeMasterDetailView(@Autowired SampleFoodProductService sampleFoodProductService) {
